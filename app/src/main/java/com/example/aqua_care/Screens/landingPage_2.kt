...
fun landingPage_2(
    ...
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.landing_image_2),
                contentDescription = null,
            )
            Spacer(modifier.height(37.dp)
            )
            opensanstext(
                text = "Aplikasi yang siap bantuin kamu",
                size = 16.sp,
                fontFamily = opensansbold,
                color = Color(0xFF272727),
                onItemclicked = null
            ...
            opensanstext(
                text = "untuk melacak penyakit pada ikan.",
                size = 16.sp,
                fontFamily = opensansbold,
                color = Color(0xFF272727),
                onItemclicked = null
